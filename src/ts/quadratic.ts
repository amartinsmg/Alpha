  ...
  /**
    ...
    returns an object with its properties.
      ...
      @returns Object containing the properties of the quadratic function:
        ...
        plotPoints: object containing the coordinates for the function's graph, with one array for the x values and another for the y values.
        roots: array with the real roots of the function in TeX format, or a message if the function has no real roots.
        vertex: string with the coordinates of the vertex of the parabola generated by the function, in TeX format.
  */
  ...
  /**
    Formats the roots found by Algebrite library.
      @param rootsObj - An object containing the roots found by Algebrite library in symbolic form.
  ...
  /**
    Convert the roots found by Algebrite library to array of string with numeric values
